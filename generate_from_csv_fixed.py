...
def generate_entity_classes(data: List[Dict[str, str]], output_dir: str) -> None:
    ...
    generate_sensor_classes(sensors, f"{output_dir}/sensor.py", data)
...
def generate_sensor_classes(sensors: List[Dict[str, str]], output_path: str, data: List[Dict[str, str]]) -> None:
